...
export default function ProximityHover({
    ...
    // Live props mirror so the rAF loop always reads current values
    ...
    // Per-particle eased size buffer for smooth bloom on enter/leave
    ...
    useEffect(() => {
        ...
        // Keep canvas backing store in sync with the container's layout box.
        // Measured every frame so Framer-canvas resizes are always picked up.
        const syncSize = () => {
        ...
        // Build the shape path centered at (cx, cy), bounding size s
        ...
        const draw = () => {
            ...
            // Grid derived from the current size + props every frame so it
            // always fills the whole box, even after a canvas resize.
            ...
            for (let j = 0; j < rows; j++) {
                for (let i = 0; i < cols; i++) {
                    ...
                    // Ease toward the target for a smooth bloom
...
ProximityHover.displayName = "Proximity Hover"