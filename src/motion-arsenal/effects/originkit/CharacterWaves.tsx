// @ts-nocheck -- upstream Originkit canvas port relies on dynamically typed refs/callbacks.
...
import { RenderTarget, useIsStaticRenderer } from "./framerRuntime"

/**
 * Character Wave
 * A field of characters animated by layered pseudo-noise, with optional cursor interaction.
 *
 ...
 */
export default function CharacterWave(props) {
    const {
        characters,
        elementSize,
        color,
