    ...
    <section className="nihl-stage" aria-labelledby={`${id}-title`}>
      ...
      <div className="nihl-shell">
        ...
        <div
          ...
          style={{ '--nihl-x': `${point.x}%`, '--nihl-y': `${point.y}%`, '--nihl-size': `${safeLens}px`, '--nihl-zoom': safeZoom } as React.CSSProperties}
        >
