...
export const PREMIUM_CATALOG: EffectEntry[] = [
  {
    meta: {
      ...
      name: 'NoxCaseStudyGallery',
      displayName: 'NOX Case Study Gallery',
      category: 'premium',
      ...
      importPath: '@/motion-arsenal/effects/premium/NoxCaseStudyGallery',
      usageJsx: '<NoxCaseStudyGallery variant="case-studies" layout="editorial" enableLightbox showCaptions />',
      props: [
        ...
        { key: 'showCaptions', label: 'Captions', type: 'boolean', default: true },
        { key: 'enableLightbox', label: 'Lightbox', type: 'boolean', default: true },
        { key: 'autoplay', label: 'Autoplay', type: 'boolean', default: false },
        { key: 'autoplayDelay', label: 'Autoplay Delay', type: 'range', default: 5200, min: 2400, max: 9000, step: 200 },
      ],
      improvementStatus: 'improved',
      lastImprovedAt: '2026-07-31T08:55:00.000Z',
      lastImprovedBy: 'foundry-live',
      improvementVersion: '1.0.0',
      improvementChangelog: [
        'Added a reusable production gallery with editorial, bento, and carousel layouts for NOX and customer websites.',
        'Added accessible lightbox navigation, keyboard controls, touch swipe, lazy image loading, and custom item support.',
